...
Rule: Keep changelog entries concise and brief. 160 characters is the maximum. Only include the "what" in the changelog entry; the "why" is in the ticket, the "how" is in the commit.
